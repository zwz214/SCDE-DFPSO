% Acknowledgement:
% This Matlab function is provided by Dr. P. N. Suganthan, and we have done minor
% revisions.

function f = benchmark_func1(x, func_num, o, A, M, a, alpha, b)
...
function f = rastrigin_rot_func(x, o, A, M, a, alpha, b)
[ps, D] = size(x);
if length(o) >= D
    o = o(1 : D);
else
...
function [f] = weierstrass_rot(x, o, A, M, a, alpha, b)
[ps, D] = size(x);
if length(o) >= D
    o = o(1 : D);
else
...
function f = schwefel_213(x, o, A, M, a, alpha, b)%after Fletcher and Powell
[ps, D] = size(x);
if length(alpha) >= D
...
function fit = EF8F2_func(x, o, A, M, a, alpha, b)
[ps, D] = size(x);
if length(o) >= D
    o = o(1 : D);
else
...
function f = E_ScafferF6_func(x, o, A, M, a, alpha, b)
...
function fit = hybrid_func1(x, o, A, M, a, alpha, b)
[ps, D] = size(x);
fun_num = 10;
if length(o(1, :)) >= D
    o = o(:, 1 : D);
...
function fit = hybrid_rot_func1(x, o, A, M, a, alpha, b)
[ps, D] = size(x);
fun_num = 10;
if length(o(1, :)) >= D
    o = o(:, 1 : D);
...
function fit = hybrid_rot_func1_noise(x, o, A, M, a, alpha, b)
[ps, D] = size(x);
fit = hybrid_rot_func1(x, o, A, M, a, alpha, b).* (1 + 0.2.* abs(normrnd(0, 1, ps, 1)));
%----------------------------------------------------------------
% 18.	Rotated Hybrid Composition Function 2
function fit = hybrid_rot_func2(x, o, A, M, a, alpha, b)
[ps, D] = size(x);
fun_num = 10;
if length(o(1, :)) >= D
    o = o(:, 1 : D);
...
function fit = hybrid_rot_func2_narrow(x, o, A, M, a, alpha, b)
[ps, D] = size(x);
fun_num = 10;
if length(o(1, :)) >= D
    o = o(:, 1 : D);
...
function fit = hybrid_rot_func2_onbound(x, o, A, M, a, alpha, b)
[ps, D] = size(x);
fun_num = 10;
if length(o(1, :)) >= D
    o = o(:, 1 : D);
...
function fit = hybrid_rot_func3(x, o, A, M, a, alpha, b)
[ps, D] = size(x);
fun_num = 10;
if length(o(1, :)) >= D
    o = o(:, 1 : D);
...
function fit = hybrid_rot_func3_highcond(x, o, A, M, a, alpha, b)
[ps, D] = size(x);
fun_num = 10;
if length(o(1, :)) >= D
    o = o(:, 1 : D);
...
function fit = hybrid_rot_func3_noncont(x, o, A, M, a, alpha, b)
[ps, D] = size(x);
o_ = o(1, 1 : D);
o_ = repmat(o_, ps, 1);
x = (abs(x - o_)<0.5).* x + (abs(x - o_) >= 0.5).* (round(x.* 2)./2);
fit = hybrid_rot_func3(x, o, A, M, a, alpha, b);
%-----------------------------------------
% 24.	Rotated Hybrid Composition Function 4
function fit = hybrid_rot_func4(x, o, A, M, a, alpha, b)
[ps, D] = size(x);
fun_num = 10;
if length(o(1, :)) >= D
    o = o(:, 1 : D);
